...
.img-frame, .button, .sml-button, #currency, .dd, #language, .dd ul, #currency ul, #language ul, #header #cart .heading, .mini-cart-info .image a, .pagination .links b, .prd-block, .prd-block1 .image, .product-list .image, .product-list .info-wrp, .column .banner, .col-prd .image, .category-info .image, .refine-cate ul li a, .product-filter .display b, .product-info .image, .product-info .thumb-wrapper, .write-review, .contactus .left, #footer .contact-info .ph-image, #footer .contact-info .fax-image, #footer .contact-info .email-image, .navigation-bar, .tags a {
	box-shadow: none;
}
...
.head1 #header .button-search { box-shadow: none; border-radius: 4px; }
.head1 #header #search .search-box { background: #474747; border-radius: 5px; }
.head1 #header #search .search-box input { border-radius: 4px; width: 170px; background-color: #373737; color: #fff; }
...
.dd .dd-hdl:after { background-image:url(../image/rgen/theme8/user.png); }
