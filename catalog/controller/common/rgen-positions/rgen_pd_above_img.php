<?php
class ControllerCommonRgenPositionsRGenPdAboveImg extends Controller {
		...
		******************************/
        ...
        foreach ($extensions as $extension) {
            ...
            if ($modules) {
            	foreach ($modules as $module) {
            		...
            		if ($module['position'] == 'pd_above_img' && $module['status']) {
        ...
        foreach ($module_data as $module) {
 		...
 		if($this->config->get('config_template') == "rgen-opencart"){
	        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/rgen-positions/rgen_pd_above_img.tpl')) {
	            $this->template = $this->config->get('config_template') . '/template/common/rgen-positions/rgen_pd_above_img.tpl';
	        }
	        $this->render();
        }
    }
