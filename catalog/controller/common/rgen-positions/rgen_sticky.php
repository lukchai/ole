<?php
class ControllerCommonRgenPositionsRGenSticky extends Controller {
		...
		******************************/
        ...
        foreach ($extensions as $extension) {
            ...
            if ($modules) {
            	foreach ($modules as $module) {
            		...
            		if ($module['position'] == 's_right' && $module['status'] || 
            			$module['position'] == 's_left' && $module['status']) {
        ...
        foreach ($module_data as $module) {
 		...
 		if($this->config->get('config_template') == "rgen-opencart"){
	        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/rgen-positions/rgen_sticky.tpl')) {
	            $this->template = $this->config->get('config_template') . '/template/common/rgen-positions/rgen_sticky.tpl';
	        }
	        $this->render();
        }
    }
