<?php
class ControllerCommonRgenPositionsRGenFooter extends Controller {
		...
		******************************/
        ...
        foreach ($extensions as $extension) {
            ...
            if ($modules) {
            	foreach ($modules as $module) {
            		...
            		if ($module['position'] == 'ft_social' && $module['status']) {
        ...
        foreach ($module_data as $module) {
 		...
 		if($this->config->get('config_template') == "rgen-opencart"){
	        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/rgen-positions/rgen_footer.tpl')) {
	            $this->template = $this->config->get('config_template') . '/template/common/rgen-positions/rgen_footer.tpl';
	        }
	        $this->render();
        }
    }
