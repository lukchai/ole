<?php
class ModelRgenRgenGallery extends Model {

	public $settingsTable = 'rgen_gallery';
	public $descriptionTable = 'rgen_gallery_description';
	...
	public function RGenGetDescription($mod_id, $store_id = 0) {
		...
		foreach ($query->rows as $result) {
			...
			$data['image_data'][$result['banner_id']]['image'][1] = $result['image'];
		}
		return $data;
	}
