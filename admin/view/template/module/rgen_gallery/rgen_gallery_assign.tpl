				...
				<tr id="row<?php echo $module_row; ?>">
					<td class="section-settings">
						<div class="form-horizontal frm-small">
							...
							<div class="control-group">
								<label class="control-label">Gallery settings</label>
								<div class="controls">
									...
									<br>
									<?php if (isset($dbKey)) { 
										$bnrData = explode("|", $dbKey);
										?><img src="view/image/rgen_theme/rgen_bnr_mod_typ<?php echo $bnrData[0]; ?>.png" alt="Grid type" width="300" class="mb10" />
									<?php } ?>
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									<label class="lbl-1" style="display: inline-block;">
										...
										Fill thumb image in thumb block
									</label>
								</div>
							</div>
...
function addModule() {	
	...
	html += '						Fill thumb image in thumb block'
	html += '					</label>';
	html += '				</div>';
	html += '			</div>';
